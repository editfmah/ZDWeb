    ...
    func content(_ c: WebRequestContext) -> WebResponseObject? {
        ...
        c.html(language: "EN") {
            c.head {
                ...
                c.script(url: "https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js")
                c.text("<script src=\"https://kit.fontawesome.com/7c67e0b7bb.js\" crossorigin=\"anonymous\"></script>")
            }
            c.view {
